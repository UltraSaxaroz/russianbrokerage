...
export default function AsidePanel({children}: {children: ReactNode}) {
    ...
    return (
        <>
            {isMobile && (
                ...
                >
                    {isOpen ?
                        <div className={'bg-black rounded-md p-2 transition-all'}><X className="text-white w-6 h-6"/>
                        </div> : <Menu className="w-6 h-6"/>}
                </button>
            )}
            ...
            <div className={`${isMobile ? '' : 'lg:ml-72'}`}>
